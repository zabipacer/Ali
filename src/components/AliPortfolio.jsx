...
const MohammadAliPortfolio = () => {
  ...
  <HeroWithImageShowreel/>
      ...
      {/* Enhanced Trust Bar */}
      <section className="py-16 bg-zinc-900/50 border-y border-zinc-800 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
          <div className="text-center space-y-8">
            <p className="text-zinc-400 font-medium text-sm uppercase tracking-wider">TRUSTED BY INDUSTRY LEADERS</p>
            
            {/* Logo Grid with Hover Effects */}
            <div className="flex flex-wrap justify-center items-center gap-12 md:gap-16 opacity-70 hover:opacity-100 transition-opacity duration-300">
              {[
                ...
                <div key={index} className={`${brand.color} font-bold text-xl hover:scale-110 transition-transform duration-300 cursor-pointer`}>
                  {brand.name}
                </div>
              ))}
            </div>
